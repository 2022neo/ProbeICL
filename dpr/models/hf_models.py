...
def get_scheduler(
    ...
    scheduler = None
    if schedule == 'linear':
        scheduler = get_schedule_linear(optimizer,
                                        warmup_steps,
                                        total_train_steps)
        ...
        pass
    elif schedule == 'warmupexponentialdecay':
        pass
    else:
        pass
    return scheduler
...
class BertTensorizer(Tensorizer):
    ...
    def ids_to_tensor(self,token_ids,add_special_tokens: bool = True,apply_max_len: bool = True):
        seq_len = self.max_length
